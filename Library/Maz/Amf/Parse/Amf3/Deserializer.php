 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Maz_Amf_Parse_Amf3_Deserializer extends Maz_Amf_Parse_Deserializer
{
    /**
     ...
     * @throws Maz_Amf_Exception for unidentified marker type
     */
    public function readTypeMarker($typeMarker = null)
    {
        ...
        switch($typeMarker) {
            case Maz_Amf_Constants::AMF3_UNDEFINED:
                 return null;
            ...
            case Maz_Amf_Constants::AMF3_XML:
            case Maz_Amf_Constants::AMF3_XMLSTRING:
                 return $this->readXmlString();
            case Maz_Amf_Constants::AMF3_BYTEARRAY:
                 return $this->readString();
            default:
                require_once 'Maz/Amf/Exception.php';
                throw new Maz_Amf_Exception('Unsupported type marker: ' . $typeMarker);
        }
    }
    ...
    public function readString()
    {
        ...
        if (($stringReference & 0x01) == 0) {
            ...
            if ($stringReference >= count($this->_referenceStrings)) {
                require_once 'Maz/Amf/Exception.php';
                throw new Maz_Amf_Exception('Undefined string reference: ' . $stringReference);
            }
    ...
    public function readDate()
    {
        ...
        if (($dateReference & 0x01) == 0) {
            ...
            if ($dateReference>=count($this->_referenceObjects)) {
                require_once 'Maz/Amf/Exception.php';
                throw new Maz_Amf_Exception('Undefined date reference: ' . $dateReference);
            }
    ...
    public function readArray()
    {
        ...
        if (($arrayReference & 0x01)==0){
            ...
            if ($arrayReference>=count($this->_referenceObjects)) {
                require_once 'Maz/Amf/Exception.php';
                throw new Maz_Amf_Exception('Unknow array reference: ' . $arrayReference);
            }
