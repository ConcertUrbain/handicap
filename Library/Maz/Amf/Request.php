...
/** Maz_Amf_Parse_InputStream */
require_once 'Maz/Amf/Parse/InputStream.php';

/** Maz_Amf_Parse_Amf0_Deserializer */
require_once 'Maz/Amf/Parse/Amf0/Deserializer.php';

/** Maz_Amf_Constants */
require_once 'Maz/Amf/Constants.php';

/** Maz_Amf_Value_MessageHeader */
require_once 'Maz/Amf/Value/MessageHeader.php';
 ...
 * types and storing the data for Maz_Amf_Server to handle for processing.
 *
...
class Maz_Amf_Request
{
    ...
    /**
     * @var Maz_Amf_Parse_InputStream
     */
    protected $_inputStream;

    /**
     * @var Maz_Amf_Parse_AMF0_Deserializer
     */
     ...
     * @return Maz_Amf_Request
     */
    public function initialize($request)
    {
        $this->_inputStream  = new Maz_Amf_Parse_InputStream($request);
        $this->_deserializer = new Maz_Amf_Parse_AMF0_Deserializer($this->_inputStream);
     ...
     *
     * @param  Maz_Amf_Parse_InputStream
     * @return Maz_Amf_Request
     */
    public function readMessage(Maz_Amf_Parse_InputStream $stream)
    {
        $clientVersion = $stream->readUnsignedShort();
        if (($clientVersion != Maz_Amf_Constants::AMF0_OBJECT_ENCODING)
            && ($clientVersion != Maz_Amf_Constants::AMF3_OBJECT_ENCODING)
        ) {
            require_once 'Maz/Amf/Exception.php';
            throw new Maz_Amf_Exception('Unknown Player Version ' . $clientVersion);
        }
     ...
     * - DATA Object
     *
     * @return Maz_Amf_Value_MessageHeader
     */
    public function readHeader()
    {
        ...
        try {
            ...
            require_once 'Maz/Amf/Exception.php';
            throw new Maz_Amf_Exception('Unable to parse ' . $name . ' header data: ' . $e->getMessage() . ' '. $e->getLine());
        }

        $header = new Maz_Amf_Value_MessageHeader($name, $mustRead, $data, $length);
        return $header;
    }
     ...
     *
     * @return Maz_Amf_Value_MessageBody
     */
    public function readBody()
    {
        ...
        try {
            ...
            require_once 'Maz/Amf/Exception.php';
            throw new Maz_Amf_Exception('Unable to parse ' . $targetURI . ' body data ' . $e->getMessage());
        }

        // Check for AMF3 objectEncoding
        if ($this->_deserializer->getObjectEncoding() == Maz_Amf_Constants::AMF3_OBJECT_ENCODING) {
            /*
            ...
            $this->_objectEncoding = Maz_Amf_Constants::AMF3_OBJECT_ENCODING;
        }

        $body = new Maz_Amf_Value_MessageBody($targetURI, $responseURI, $data);
        return $body;
    }
     ...
     *
     * @param  Maz_Amf_Value_MessageBody $message
     * @return Maz_Amf_Request
     */
    public function addAmfBody(Maz_Amf_Value_MessageBody $message)
    {
