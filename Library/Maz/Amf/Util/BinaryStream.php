 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Maz_Amf_Util_BinaryStream
{
    /**
    ...
    public function __construct($stream)
    {
        if (!is_string($stream)) {
            ...
            throw new Maz_Amf_Exception('Inputdata is not of type String');
        }
     ...
     * @param  int $length
     * @return string
     * @throws Maz_Amf_Exception for buffer underrun
     */
    public function readBytes($length)
    {
        if (($length + $this->_needle) > strlen($this->_stream)) {
            require_once 'Maz/Amf/Exception.php';
            throw new Maz_Amf_Exception("Buffer underrun at needle position: " . $this->_needle . " while requesting length: " . $length);
        }
     ...
     *
     * @param  string $bytes
     * @return Maz_Amf_Util_BinaryStream
     */
