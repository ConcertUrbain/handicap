...
/** Maz_Amf_Parse_OutputStream */
require_once 'Maz/Amf/Parse/OutputStream.php';

/** Maz_Amf_Parse_Amf0_Serializer */
require_once 'Maz/Amf/Parse/Amf0/Serializer.php';
...
class Maz_Amf_Response
{
    ...
    /**
     * Array of Maz_Amf_Value_MessageBody objects
     * @var array
     */
    protected $_bodies = array();

    /**
     * Array of Maz_Amf_Value_MessageHeader objects
     * @var array
     */
    protected $_headers = array();

    /**
     * @var Maz_Amf_Parse_OutputStream
     */
    ...
    {
        $this->_outputStream = new Maz_Amf_Parse_OutputStream();
     ...
     *
     * @param  Maz_Amf_Parse_OutputStream $stream
     * @return Maz_Amf_Response
     */
    public function writeMessage(Maz_Amf_Parse_OutputStream $stream)
    {
        ...
        foreach ($this->getAmfHeaders() as $header) {
            $serializer = new Maz_Amf_Parse_Amf0_Serializer($stream);
            $stream->writeUTF($header->name);
            $stream->writeByte($header->mustRead);
            $stream->writeLong(Maz_Amf_Constants::UNKNOWN_CONTENT_LENGTH);
        ...
        foreach ($this->_bodies as $body) {
            ...
            $stream->writeLong(Maz_Amf_Constants::UNKNOWN_CONTENT_LENGTH);
            if($this->_objectEncoding == Maz_Amf_Constants::AMF0_OBJECT_ENCODING) {
                $serializer->writeTypeMarker($body->getData());
            } else {
                // Content is AMF3
                $serializer->writeTypeMarker($body->getData(),Maz_Amf_Constants::AMF0_AMF3);
            }
        }
     ...
     *
     * @param  Maz_Amf_Value_MessageBody $body
     * @return Maz_Amf_Response
     */
    public function addAmfBody(Maz_Amf_Value_MessageBody $body)
    {
        $this->_bodies[] = $body;
        return $this;
    }
     ...
     *
     * @param  Maz_Amf_Value_MessageHeader $header
     * @return Maz_Amf_Response
     */
    public function addAmfHeader(Maz_Amf_Value_MessageHeader $header)
    {
     ...
     *
     * @return array Array of Maz_Amf_Value_MessageHeader objects
     */
