...
require_once 'Maz/Amf/Parse/Deserializer.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Maz_Amf_Parse_Amf0_Deserializer extends Maz_Amf_Parse_Deserializer
{
    /**
     ...
     * @var int
     */
    protected $_objectEncoding = Maz_Amf_Constants::AMF0_OBJECT_ENCODING;

    /**
     * refrence to AMF3 deserializer
     *
     * @var Maz_Amf_Parse_Amf3_Deserializer
     */
     ...
     * @return mixed
     * @throws Maz_Amf_Exception for invalid type
     */
    public function readTypeMarker($typeMarker = null)
    {
        ...
        switch($typeMarker) {
            ...
            // undefined
            case Maz_Amf_Constants::AMF0_UNDEFINED:
                return null;

            // Circular references are returned here
            case Maz_Amf_Constants::AMF0_REFERENCE:
            ...
            case Maz_Amf_Constants::AMF0_UNSUPPORTED:
                return null;

            // XML
            case Maz_Amf_Constants::AMF0_XML:
            ...
            default:
                ...
                throw new Maz_Amf_Exception('Unsupported marker type: ' . $typeMarker);
        }
    }
    ...
    public function readObject($object = null)
    {
        ...
        while (true) {
            ...
            $typeMarker = $this->_stream->readByte();
            if ($typeMarker != Maz_Amf_Constants::AMF0_OBJECTTERM ){
     ...
     *
     * @return object
     * @throws Maz_Amf_Exception for invalid reference keys
     */
    public function readReference()
    {
        ...
        if (!array_key_exists($key, $this->_reference)) {
            require_once 'Maz/Amf/Exception.php';
            throw new Maz_Amf_Exception('Invalid reference key: '. $key);
        }
     ...
     * Get deserializer
     *
     * @return Maz_Amf_Parse_Amf3_Deserializer
     */
    public function getDeserializer()
    {
        if (null === $this->_deserializer) {
            require_once 'Maz/Amf/Parse/Amf3/Deserializer.php';
            $this->_deserializer = new Maz_Amf_Parse_Amf3_Deserializer($this->_stream);
        }
