...
/** Maz_Amf_Request */
require_once 'Maz/Amf/Request.php';

/**
 * AMF Request object -- Request via HTTP
 *
 * Extends {@link Maz_Amf_Request} to accept a request via HTTP. Request is
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Maz_Amf_Request_Http extends Maz_Amf_Request
{
    /**
     * Raw AMF request
     * @var string
